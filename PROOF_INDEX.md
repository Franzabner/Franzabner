...
| [`infrastructure-energy-studies`](https://github.com/Franzabner/infrastructure-energy-studies) | Public scaffold route for synthetic infrastructure energy studies, solar-to-hydrogen, water-current-to-electricity, control states, safety boundaries, and validation limits. | `scaffolded`; public scaffold only, not released. |
| [`civic-infrastructure-production-systems`](https://github.com/Franzabner/civic-infrastructure-production-systems) | Public scaffold route for synthetic civic infrastructure production studies with Foundation-adjacent engineering separation. | `scaffolded`; public scaffold only, not released. |
