...
| Architecture | The approved 17-repo architecture as an architecture plan, with two Phase 2 public scaffold repos, two Phase 3 public scaffold repos, and 11 remaining umbrella repos held at `planned` until created and reviewed. |
