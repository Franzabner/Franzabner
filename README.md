...
| [fine-tuning-lab-notes](https://github.com/Franzabner/fine-tuning-lab-notes) | Third derivative public repo: public-safe fine-tuning lab-note scaffold with synthetic-only examples, dataset prep boundary, model release gate, evaluation note template, and Hugging Face planned/template-only routing. | Public scaffold. Release status: scaffolded. License pending human review. No private corpora, private weights, training logs, eval results, model, dataset, Space, hosted artifact, real training run, model output, deployment, or live service claim. |
