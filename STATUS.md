...
| Phase 3 public scaffold routes | `electrical-controls-architecture` and `embedded-hardware-lab`; public scaffold only, not released. |
| Phase 4 public scaffold routes | `engineering-simulation-lab` and `data-model-infrastructure`; public scaffold only, not released. |
| Phase 5 public scaffold routes | `infrastructure-energy-studies` and `civic-infrastructure-production-systems`; public scaffold only, not released. |
| Phase 6 public scaffold routes | `engineering-standards-and-validation`, `engineering-security-boundary`, and `engineering-deliverables-template`; public scaffold only, not released. |
| Phase 7 public scaffold routes | `application-development-systems`, `immersive-access-systems`, `automated-engineering-systems`, and `agentic-engineering-workforce`; public scaffold only, not released. |
| Remaining umbrella repos | None in the approved 17-repo architecture; no repo is promoted beyond `scaffolded`. |
...
- `modular-infrastructure-studies`, `cad-mechanical-design-lab`, `electrical-controls-architecture`, `embedded-hardware-lab`, `engineering-simulation-lab`, `data-model-infrastructure`, `infrastructure-energy-studies`, `civic-infrastructure-production-systems`, `engineering-standards-and-validation`, `engineering-security-boundary`, `engineering-deliverables-template`, `application-development-systems`, `immersive-access-systems`, `automated-engineering-systems`, and `agentic-engineering-workforce` for scaffolded public proof-surface routing only.

Human review decides whether the control repo routing updates are safe to push and whether any Phase 2, Phase 3, Phase 4, Phase 5, Phase 6, or Phase 7 public scaffold can later be promoted beyond `scaffolded`.
